...
const Form = () => {
  ...
  // checking the age of the user on change of date input
...
{/* Country will be populated from database */}
  <div className="mb-2">
...
{/* city will be populated from database */}
  <div className="mb-2 d-flex">
